...
class ApisResourceServer
{
    ...
    public function setAuthenticationHeader($authenticationHeader)
    {
        // must be string
        if (!is_string($authenticationHeader)) {
            return;
        }
    ...
    public function verifyToken()
    {
        ...
        if (null == $this->authenticationHeader) {
            throw new ResourceServerException("no_authentication", "not authenticated");
        }
        ...
        try {
            ...
            $request->getQuery()->add("access_token", $bearerToken);
